...
@import url('https://fonts.googleapis.com/css2?family=Oswald:wght@300;500;700&family=Roboto&display=swap');
...
/*     
    display:grid; align-items:center; padding: 50px; box-sizing:border-box;
    grid-template-columns: 1fr 1fr; height:100vh; gap:50px;
    grid-template-rows: auto 1fr;
    ...
    nav{grid-column:1/3; z-index:2}
    .poster{justify-self: end; z-index:2;
        img{height:50%}
    }
    .review{justify-self: start; z-index:2;
         div{width:60%;color: ${p => p.theme.color};
...
/*     @media (max-width:1024px ) {
        ...
        .review{
            div{width:100%;
                h1{font-size:5vw; line-height:4.5vw;}
                span{font-size:4vw;}  
            }
        }
    }
    ...
    @media (max-width:600px ) {
        height:auto;grid-template-columns: 1fr; grid-template-rows: auto;padding: 50px 20px;
